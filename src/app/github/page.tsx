    ...
    <div className="max-w-2xl mx-auto text-center">
      <div className="bg-white border border-slate-200 rounded-xl p-8 shadow-sm">
        <svg
          viewBox="0 0 24 24"
          fill="currentColor"
          className="w-14 h-14 mx-auto text-slate-900"
        >
        ...
        <h1 className="text-3xl font-bold text-slate-900 mt-4">Source Code</h1>
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 mt-6 bg-slate-900 hover:bg-slate-800 text-white px-5 py-3 rounded-md text-sm font-medium transition"
        >
